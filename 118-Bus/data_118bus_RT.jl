...
for i in 1:75
	solardf_path = joinpath(@__DIR__, "Solar/RT", "Solar$(i)RT.csv")
...
for i in 1:17
    winddf_path = joinpath(@__DIR__, "Wind/RT", "Wind$(i)RT.csv")
...
for i in 1:3
    loaddf_path = joinpath(@__DIR__, "Load/RT", "LoadR$(i)RT.csv")
