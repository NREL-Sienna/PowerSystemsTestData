...
thermal_generators14(nodes14) = [
    ThermalStandard(
        ...
        time_limits = nothing,
        ramp_limits = nothing,
        operation_cost = ThermalGenerationCost(CostCurve(InputOutputCurve(QuadraticFunctionData(0.0430292599, 20.0, 0.0))), 0.0, 0.0, 0.0),
        base_power = 100.0,
    ),
    ThermalStandard(
        name = "Bus2",
        ...
        time_limits = nothing,
        ramp_limits = nothing,
        operation_cost = ThermalGenerationCost(CostCurve(InputOutputCurve(QuadraticFunctionData(0.25, 20.0, 0.0))), 0.0, 0.0, 0.0),
        base_power = 100.0,
    ),
    ThermalStandard(
        name = "Bus3",
        ...
        time_limits = nothing,
        ramp_limits = nothing,
        operation_cost = ThermalGenerationCost(CostCurve(InputOutputCurve(QuadraticFunctionData(0.01, 40.0, 0.0))), 0.0, 0.0, 0.0),
        base_power = 100.0,
    ),
    ThermalStandard(
        name = "Bus6",
